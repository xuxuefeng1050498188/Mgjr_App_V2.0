...
import com.mgjr.model.impl.AddBankCardModelImpl;
 ...
 */
public class AddBankCardPresenterImpl implements OnPresenterListener<BaseBean> {

    private ViewListener<BaseBean> viewListener;
    private BaseModel baseModel;

    public AddBankCardPresenterImpl(final ViewListener<BaseBean> viewListener) {
        this.viewListener = viewListener;
        baseModel = new AddBankCardModelImpl();
    }
