...
import com.mgjr.model.impl.ProfileMyinfosUploadHeadImageModelImpl;
 ...
 */
public class ProfileMyinfosUploadHeadImagePresenterImpl implements OnPresenterListener<BaseBean> {

    private ViewListener<BaseBean> viewListener;
    private BaseModel baseModel;

    public ProfileMyinfosUploadHeadImagePresenterImpl(ViewListener<BaseBean> viewListener) {
        this.viewListener = viewListener;
        baseModel = new ProfileMyinfosUploadHeadImageModelImpl();
    }
