...
public class GestureLockView extends View {
     ...
     * @return
     */
    public int getmColorFingerUp() {
        return mColorFingerUp;
    }
    ...
    public int getmColorFingerOn() {
        return mColorFingerOn;
    }

    public void setmColorFingerOn(int mColorFingerOn) {
        this.mColorFingerOn = mColorFingerOn;
    }

    public int getmColorNoFingerOutter() {
        return mColorNoFingerOutter;
    }

    public void setmColorNoFingerOutter(int mColorNoFingerOutter) {
        this.mColorNoFingerOutter = mColorNoFingerOutter;
    }

    public int getmColorNoFingerInner() {
        return mColorNoFingerInner;
    }

    public void setmColorNoFingerInner(int mColorNoFingerInner) {
