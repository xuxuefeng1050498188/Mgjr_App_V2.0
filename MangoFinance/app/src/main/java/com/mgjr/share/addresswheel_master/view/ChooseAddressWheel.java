package com.mgjr.share.addresswheel_master.view;
...
import com.mgjr.R;
import com.mgjr.share.addresswheel_master.adapter.AreaWheelAdapter;
import com.mgjr.share.addresswheel_master.adapter.CityWheelAdapter;
import com.mgjr.share.addresswheel_master.adapter.ProvinceWheelAdapter;
...
import com.mgjr.share.addresswheel_master.view.wheelview.MyOnWheelChangedListener;
import com.mgjr.share.addresswheel_master.view.wheelview.MyWheelView;
...
public class ChooseAddressWheel implements MyOnWheelChangedListener {
    ...
    MyWheelView cityWheel;
    @InjectView(R.id.district_wheel)
    MyWheelView districtWheel;
