...
public class FriendListModelImpl implements BaseModel {
    ...
    public void sendRequest(Map<String, String> necessaryParams, Map<String, String> unNecessaryParams, OnPresenterListener listener) {
        ...
        String url = APIBuilder.baseUrl + APIBuilder.version + APIBuilder.friendlistUrl();
        List<String> keyList = new ArrayList<>();
        keyList.add(APIBuilder.friendlistUrl());
    ...
    private class CustomCallback extends Callback<FriendListBean> {
        @Override
        public FriendListBean parseResponse(Response response) throws Exception {
            String string = response.body().string();
            PhoneUtils.setSystemErrorReason(string);
            Gson gson = new GsonBuilder().create();
            FriendListBean friendListBean = gson.fromJson(string,FriendListBean.class);
        ...
        @Override
        public void onResponse(FriendListBean response) {
