 ...
 */
public class MyJmgInvestDetailModelImpl implements BaseModel {
    ...
    public void sendRequest(Map<String, String> necessaryParams, Map<String, String> unNecessaryParams, OnPresenterListener listener) {
        ...
        String url = APIBuilder.baseUrl + APIBuilder.version + APIBuilder.myJmgInvestDetailUrl();

        List<String> keyList = new ArrayList<String>();
        keyList.add(APIBuilder.myJmgInvestDetailUrl());
    ...
    private class CustomCallback extends Callback<MyJmgInvestDetailBean> {
        @Override
        public MyJmgInvestDetailBean parseResponse(Response response) throws Exception {
            String string = response.body().string();
            PhoneUtils.setSystemErrorReason(string);
            Gson gson = new GsonBuilder().create();
            MyJmgInvestDetailBean myJmgInvestDetailBean = gson.fromJson(string, MyJmgInvestDetailBean.class);
            return myJmgInvestDetailBean;
        }
        ...
        @Override
        public void onResponse(MyJmgInvestDetailBean response) {
