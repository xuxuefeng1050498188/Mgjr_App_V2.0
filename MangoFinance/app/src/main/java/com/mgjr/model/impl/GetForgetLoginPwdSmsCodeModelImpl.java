 ...
 */
public class GetForgetLoginPwdSmsCodeModelImpl implements BaseModel {
    ...
    private class CustomCallback extends Callback<BaseBean> {
        ...
        public BaseBean parseResponse(Response response) throws Exception {
            ...
            BaseBean forgetLoginPwdBean = gson.fromJson(string, BaseBean.class);
            return forgetLoginPwdBean;
        }
