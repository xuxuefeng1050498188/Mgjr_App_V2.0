 ...
 */
public class EventsModelImpl implements BaseModel {
    ...
    public void sendRequest(Map<String, String> necessaryParams, Map<String, String> unNecessaryParams, OnPresenterListener listener) {
        ...
        String url = APIBuilder.baseUrl + APIBuilder.version + APIBuilder.eventsUrl();
        List<String> keyList = new ArrayList<>();
        keyList.add(APIBuilder.eventsUrl());
...
//
    ...
    private class CustomCallback extends Callback<EventsBean> {
        @Override
        public EventsBean parseResponse(Response response) throws Exception {
            String string = response.body().string();
            PhoneUtils.setSystemErrorReason(string);
            Gson gson = new GsonBuilder().create();
            EventsBean eventsBean = gson.fromJson(string,EventsBean.class);
            return eventsBean;
        }
        ...
        @Override
        public void onResponse(EventsBean response) {
