...
public class AdModelImpl implements BaseModel {
    ...
    public void sendRequest(Map<String, String> necessaryParams, Map<String, String> unNecessaryParams, OnPresenterListener listener) {
        ...
        String url = APIBuilder.baseUrl + APIBuilder.version + APIBuilder.advertisement();
        List<String> keyList = new ArrayList<>();
        keyList.add(APIBuilder.advertisement());
    ...
    private class CustomCallback extends Callback<AdBean> {
        @Override
        public AdBean parseResponse(Response response) throws Exception {
