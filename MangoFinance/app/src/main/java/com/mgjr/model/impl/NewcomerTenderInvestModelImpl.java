 ...
 */
public class NewcomerTenderInvestModelImpl implements BaseModel {
    ...
    public void sendRequest(Map<String, String> necessaryParams, Map<String, String> unNecessaryParams, OnPresenterListener listener) {
        ...
        String url = APIBuilder.baseUrl + APIBuilder.version + APIBuilder.newcomerTasteTenderInvestUrl();
        List<String> keyList = new ArrayList<>();
        keyList.add(APIBuilder.newcomerTasteTenderInvestUrl());
    ...
    private class CustomCallback extends Callback<MyTyjBean> {
        ...
        public MyTyjBean parseResponse(Response response) throws Exception {
            ...
            MyTyjBean newcomerTenderInvestBean = gson.fromJson(string,MyTyjBean.class);
            return newcomerTenderInvestBean;
        }
