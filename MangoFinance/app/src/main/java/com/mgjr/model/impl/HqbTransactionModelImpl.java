...
public class HqbTransactionModelImpl implements BaseModel {
    ...
    public void sendRequest(Map<String, String> necessaryParams, Map<String, String> unNecessaryParams, OnPresenterListener listener) {
        ...
        String url = APIBuilder.baseUrl + APIBuilder.version + APIBuilder.transactionDetail();

        List<String> keyList = new ArrayList<String>();
        keyList.add(APIBuilder.transactionDetail());
    ...
    private class CustomCallback extends Callback<HqbTransactionBean> {
        ...
        public HqbTransactionBean parseResponse(Response response) throws Exception {
            ...
            HqbTransactionBean hqbTransactionBean = gson.fromJson(string,HqbTransactionBean.class);
            return hqbTransactionBean;
        }
