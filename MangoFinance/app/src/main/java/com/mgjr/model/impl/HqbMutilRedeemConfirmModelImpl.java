...
public class HqbMutilRedeemConfirmModelImpl implements BaseModel {
    ...
    public void sendRequest(Map<String, String> necessaryParams, Map<String, String> unNecessaryParams, OnPresenterListener listener) {
        ...
        String url = APIBuilder.baseUrl + APIBuilder.version + APIBuilder.hqbMutilRedeemConfirm();

        List<String> keyList = new ArrayList<String>();
        keyList.add(APIBuilder.hqbMutilRedeemConfirm());
