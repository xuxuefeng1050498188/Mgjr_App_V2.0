 ...
 */
public class ProfileMyinfosUploadNicknameModelImpl implements BaseModel {
    ...
    public void sendRequest(Map<String, String> necessaryParams, Map<String, String> unNecessaryParams, OnPresenterListener listener) {
        ...
        String url = APIBuilder.baseUrl + APIBuilder.version + APIBuilder.uploadNicknameUrl();

        List<String> keyList = new ArrayList<String>();
        keyList.add(APIBuilder.uploadNicknameUrl());
        keyList.add(necessaryParams.get("mid"));
        keyList.add(necessaryParams.get("nickname"));
