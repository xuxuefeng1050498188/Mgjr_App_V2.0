 ...
 */
public class AccountManageModelImpl implements BaseModel {
    ...
    public void sendRequest(Map<String, String> necessaryParams, Map<String, String> unNecessaryParams, OnPresenterListener listener) {
        ...
        String url = APIBuilder.baseUrl + APIBuilder.version + APIBuilder.accountManageUrl();

        List<String> keyList = new ArrayList<String>();
        keyList.add(APIBuilder.accountManageUrl());
    ...
    private class CustomCallback extends Callback<AccountManageBean> {
        @Override
        public AccountManageBean parseResponse(Response response) throws Exception {
            String string = response.body().string();
            PhoneUtils.setSystemErrorReason(string);
            Gson gson = new GsonBuilder().create();
            AccountManageBean accountManageBean = gson.fromJson(string, AccountManageBean.class);
        ...
        @Override
        public void onResponse(AccountManageBean response) {
