...
public class MyHqbRunningProjectModelImpl implements BaseModel {
    ...
    public void sendRequest(Map<String, String> necessaryParams, Map<String, String> unNecessaryParams, OnPresenterListener listener) {
        ...
        String url = APIBuilder.baseUrl + APIBuilder.version + APIBuilder.myTenderingList();

        List<String> keyList = new ArrayList<String>();
        keyList.add(APIBuilder.myTenderingList());
    ...
    private class CustomCallback extends Callback<MyHqbRunningProjectBean> {
        ...
        public MyHqbRunningProjectBean parseResponse(Response response) throws Exception {
            ...
            MyHqbRunningProjectBean myHqbRunningProjectBean = gson.fromJson(string,MyHqbRunningProjectBean.class);
            return myHqbRunningProjectBean;
        }
