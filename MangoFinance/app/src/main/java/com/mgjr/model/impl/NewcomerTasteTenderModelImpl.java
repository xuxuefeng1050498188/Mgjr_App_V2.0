 ...
 */
public class NewcomerTasteTenderModelImpl implements BaseModel{
    ...
    public void sendRequest(Map<String, String> necessaryParams, Map<String, String> unNecessaryParams, OnPresenterListener listener) {
        ...
        String url = APIBuilder.baseUrl + APIBuilder.version + APIBuilder.newcomerTasteTenderUrl();
        List<String> keyList = new ArrayList<>();
        keyList.add(APIBuilder.newcomerTasteTenderUrl());
    ...
    private class CustomCallback extends Callback<MyTyjBean> {
        ...
        public MyTyjBean parseResponse(Response response) throws Exception {
            ...
            MyTyjBean newcomerTasteTenderBean = gson.fromJson(string,MyTyjBean.class);
            return newcomerTasteTenderBean;
        }
