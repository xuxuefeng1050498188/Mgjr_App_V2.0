...
public class HqbMutilRedeemListModelImpl implements BaseModel {
    ...
    public void sendRequest(Map<String, String> necessaryParams, Map<String, String> unNecessaryParams, OnPresenterListener listener) {
        ...
        String url = APIBuilder.baseUrl + APIBuilder.version + APIBuilder.hqbMutilRedeemedList();

        List<String> keyList = new ArrayList<String>();
        keyList.add(APIBuilder.hqbMutilRedeemedList());
...
//        keyList.add(necessaryParams.get("tenderIds"));
    ...
    private class CustomCallback extends Callback<MyHqbRunningProjectBean> {
        ...
        public MyHqbRunningProjectBean parseResponse(Response response) throws Exception {
            ...
            MyHqbRunningProjectBean qbMutilRedeemBean = gson.fromJson(string,MyHqbRunningProjectBean.class);
            return qbMutilRedeemBean;
        }
