 ...
 */
public class MyJmgTransactionDetailModelImpl implements BaseModel {
    ...
    public void sendRequest(Map<String, String> necessaryParams, Map<String, String> unNecessaryParams, OnPresenterListener listener) {
        ...
        String url = APIBuilder.baseUrl + APIBuilder.version + APIBuilder.myJmgTransactionDetailUrl();

        List<String> keyList = new ArrayList<String>();
        keyList.add(APIBuilder.myJmgTransactionDetailUrl());
    ...
    private class CustomCallback extends Callback<MyJmgTransactionDetailsBean> {
        @Override
        public MyJmgTransactionDetailsBean parseResponse(Response response) throws Exception {
            String string = response.body().string();
            PhoneUtils.setSystemErrorReason(string);
            LogUtil.e(string);
            //测试专用
            Gson gson = new GsonBuilder().create();
            MyJmgTransactionDetailsBean myJmgTransactionDetailsBean = gson.fromJson(string, MyJmgTransactionDetailsBean.class);
            return myJmgTransactionDetailsBean;
        }
        ...
        @Override
        public void onResponse(MyJmgTransactionDetailsBean response) {
