 ...
 */
public class HomeEventsWindowModelImpl implements BaseModel {
    ...
    public void sendRequest(Map<String, String> necessaryParams, Map<String, String> unNecessaryParams, OnPresenterListener listener) {
        ...
        String url = APIBuilder.baseUrl + APIBuilder.version + APIBuilder.homepageEventsWindow();

        List<String> keyList = new ArrayList<>();
        keyList.add(APIBuilder.homepageEventsWindow());
    ...
    private class CustomCallback extends Callback<HomepageRecommendProjectsBean> {
        ...
        public HomepageRecommendProjectsBean parseResponse(Response response) throws Exception {
            ...
            HomepageRecommendProjectsBean homepageEventBannerBean = gson.fromJson(string, HomepageRecommendProjectsBean.class);
            return homepageEventBannerBean;
        }
