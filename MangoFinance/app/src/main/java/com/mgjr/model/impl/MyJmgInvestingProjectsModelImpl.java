 ...
 */
public class MyJmgInvestingProjectsModelImpl implements BaseModel {
    ...
    public void sendRequest(Map<String, String> necessaryParams, Map<String, String> unNecessaryParams, OnPresenterListener listener) {
        ...
        String url = APIBuilder.baseUrl + APIBuilder.version + APIBuilder.myJmgInvestingProjectsUrl();

        List<String> keyList = new ArrayList<String>();
        keyList.add(APIBuilder.myJmgInvestingProjectsUrl());
    ...
    private class CustomCallback extends Callback<MyJmgInvestingProjectsBean> {
        ...
        public MyJmgInvestingProjectsBean parseResponse(Response response) throws Exception {
            ...
            MyJmgInvestingProjectsBean myJmgInvestingProjectsBean = gson.fromJson(string, MyJmgInvestingProjectsBean.class);
            return myJmgInvestingProjectsBean;
        }
