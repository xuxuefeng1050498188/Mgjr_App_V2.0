 ...
 */
public class GetVcodeModelImpl implements BaseModel {
    ...
    public void sendRequest(Map<String, String> necessaryParams, Map<String, String> unNecessaryParams, OnPresenterListener listener) {
        ...
        String url = APIBuilder.baseUrl + APIBuilder.version + APIBuilder.registerGetImgCodeUrl();

        List<String> keyList =  new ArrayList<>();
        keyList.add(APIBuilder.registerGetImgCodeUrl());
    ...
    private class CustomCallback extends Callback<GetVcodeBean> {
        ...
        public GetVcodeBean parseResponse(Response response) throws Exception {
            ...
            GetVcodeBean getVcodeBean = gson.fromJson(string, GetVcodeBean.class);
            return getVcodeBean;
        }
