 ...
 */
public class RequestRechargeModelImpl implements BaseModel {
    ...
    public void sendRequest(Map<String, String> necessaryParams, Map<String, String> unNecessaryParams, OnPresenterListener listener) {
        ...
        String url = APIBuilder.baseUrl + APIBuilder.version + APIBuilder.requestRechargeUrl();

        List<String> keyList = new ArrayList<String>();
        keyList.add(APIBuilder.requestRechargeUrl());
    ...
    private class CustomCallback extends Callback<RequestRechargeBean> {
        ...
        public RequestRechargeBean parseResponse(Response response) throws Exception {
            ...
            RequestRechargeBean requestRechargeBean = gson.fromJson(string, RequestRechargeBean.class);
            return requestRechargeBean;
        }
