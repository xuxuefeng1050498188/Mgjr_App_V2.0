 ...
 */
public class ProfileMyinfosUploadHeadImageModelImpl implements BaseModel {
    ...
    public void sendRequest(Map<String, String> necessaryParams, Map<String, String> unNecessaryParams, OnPresenterListener listener) {
        ...
        String url = APIBuilder.baseUrl + APIBuilder.version + APIBuilder.uploadHeadImageUrl();

        String headImg = necessaryParams.get("headImg");
        necessaryParams.remove("headImg");

        List<String> keyList = new ArrayList<String>();
        keyList.add(APIBuilder.uploadHeadImageUrl());
        keyList.add(necessaryParams.get("mid"));
        keyList.add(necessaryParams.get("suffix"));
        ...
        HttpClient
                .post()
                .addFile("file", "image.jpg", new File(headImg))
                .url(url)
                .params(params)
                .build()
