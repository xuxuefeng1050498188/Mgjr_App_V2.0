...
public class TenderRewardListModelImpl implements BaseModel {
    ...
    public void sendRequest(Map<String, String> necessaryParams, Map<String, String> unNecessaryParams, OnPresenterListener listener) {
        ...
        String url = APIBuilder.baseUrl + APIBuilder.version + APIBuilder.tenderRewardListUrl();

        List<String> keyList = new ArrayList<String>();
        keyList.add(APIBuilder.tenderRewardListUrl());
    ...
    private class CustomCallback extends Callback<TenderRewardListBean> {
        @Override
        public TenderRewardListBean parseResponse(Response response) throws Exception {
            String string = response.body().string();
            PhoneUtils.setSystemErrorReason(string);
            LogUtil.e(string);
            Gson gson = new GsonBuilder().create();
            TenderRewardListBean tenderRewardListBean = gson.fromJson(string, TenderRewardListBean.class);
            return tenderRewardListBean;
        }
        ...
        @Override
        public void onResponse(TenderRewardListBean response) {
