...
public class ChangeMobileModelImpl implements BaseModel {
    ...
    public void sendRequest(Map<String, String> necessaryParams, Map<String, String> unNecessaryParams, OnPresenterListener listener) {
        ...
        String url = APIBuilder.baseUrl + APIBuilder.version + APIBuilder.changeMobile();
        List<String> keyList = new ArrayList<>();
        keyList.add(APIBuilder.changeMobile());
